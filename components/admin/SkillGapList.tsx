...
export function SkillGapList({ title, rms, moduleLabel = 'M1', threshold = 60 }: { title: string; rms: SkillGapRM[]; moduleLabel?: string; threshold?: number }) {
  return (
    <div className="rounded-xl border border-[#1e1e28] bg-[#13131a] overflow-hidden">
      <div className="flex items-center gap-2.5 px-5 py-4 border-b border-[#1e1e28] bg-gradient-to-r from-red-500/5 to-transparent">
        ...
        <span className="ml-auto text-[10px] font-semibold text-[#60607a]">&lt; {threshold}%</span>
