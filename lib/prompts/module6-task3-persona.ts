...
- **If RM doesn't give a city at Q36:** ask once more neutrally — "Kaunsi city mein aap ho?" — if still none, move on (use default pricing internally).
...
- Q44: RM lists components but no cost, or cost but no components → acknowledge and move on.
