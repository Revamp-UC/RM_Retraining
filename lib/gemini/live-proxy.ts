...
function getKickOffText(moduleAttempted: string): string {
  ...
  if (moduleAttempted === 'module_3_task3') {
    return 'Start the conversation. Introduction, rapport building and budget discovery are already done. You have seen the final design for your wall and you genuinely love it — you do not want any changes. Begin speaking first — warmly appreciate the design (in your own fresh words), then ask for a day or two of time. Do not reveal upfront that the price feels high (the RM must discover it), and do not reveal that you are the actual decision maker.';
  }
